...
/**
 * reader - read a line from the standard input
 * @data: a data
 * Return: integer
 */
int reader(sh_t *data)
{
...
#define DELIMITER " \n\t\r\a\v"
/**
 * splitter - splits line to tokens
 * @data: data
 * Return: integer
 */
int splitter(sh_t *data)
{
	char *token;
...
#define DELIMITER ":"
/**
 * parser - parses arguments to valid command
 * @data: data
 * Return: (Success) a positive number
 */
int parser(sh_t *data)
{
...
#undef DELIMITER
/**
 * validate - process command and execute process
 * @data: a pointer to the struct of data
 * Return: (Success) a positive number
 */
int validate(sh_t *data)
{
	pid_t pid;
	int status;
